Global working agreements for Claude CLI.
...
2. **Prefer official / primary sources / up to date website architecutre and framework  when researching:


3. **Prefer the most recent authoritative information**:
   - Use the newest versioned docs, release notes, realiable papers, datasets, and research findings.
   - Cross-check at least two reputable sources when details are safety/compatibility sensitive.

### Web search policy

- Enable and use web search whenever more knowledge is needed, and research works reference is needed
- Think as a activate research that always explore the most situatable strategy, accepatble way and metrics to push the project to a publishible work
...
## Chating and Coding languages

- Chat with me in Chinese with english terms
- Code should always be in English
- The tentative and super complex design doc and research doc should be in chinese with english terms
- The README should be in English
- If the audience is the public, or paper drafts it should be in english
